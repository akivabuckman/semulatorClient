    ...
    return (
        <aside id="infoPaneDiv">
            <div id="round1Div" className='round1 roundDiv' round="1">
                ...
                <p>Amount Spent: <span>${props.userInputs["1"]["totalSpend"]}</span></p>
            ...
            <div id="round2Div" className='round2 roundDiv' round="2">
                ...
                <p>Amount Spent: <span>${props.userInputs["2"]["totalSpend"]}</span></p>
                <p>Cost per Click: <span>{props.userInputs["2"]["finalCpc"]}</span></p>
                <p>Total Clicks: <span>{props.userInputs["2"]["totalClicks"]}</span></p>
                <p>Conversion Rate: <span>{props.userInputs["2"]["finalConversionRate"]}</span></p>
                <p>Cost per Conversion: <span>${props.userInputs["2"]["costPerConv"]}</span></p>
            ...
            <div id="round3Div" className='round3 roundDiv' round="3">
                ...
                <p>Amount Spent: <span>${props.userInputs["3"]["totalSpend"]}</span></p>
                <p>Cost per Click: <span>{props.userInputs["3"]["finalCpc"]}</span></p>
                <p>Total Clicks: <span>{props.userInputs["3"]["totalClicks"]}</span></p>
                <p>Conversion Rate: <span>{props.userInputs["3"]["finalConversionRate"]}</span></p>
                <p>Cost per Conversion: <span>${props.userInputs["3"]["costPerConv"]}</span></p>
